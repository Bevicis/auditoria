...
def auditar():
    ...
    word_name = f"Informe_BEVI_FINAL_CORRECTO_COMPLETO_{empresa.replace(' ', '_')}.docx"
    pdf_name = f"Informe_BEVI_FINAL_CORRECTO_COMPLETO_{empresa.replace(' ', '_')}.pdf"
...
RESUMEN DEL ANÁLISIS:", style="Heading 1")
    ...
    doc.add_paragraph("
RECOMENDACIONES:", style="Heading 1")
    for item in tabla:
        if item[1] == "No":
    ...
    doc.add_paragraph(
        "
Este informe ha sido elaborado por BEVICIS como parte de su servicio de auditoría legal web. "
        "Para implementar las mejoras o resolver incidencias, puede contactar con nosotros en contacto@bevicis.com o visitar www.bevicis.com."
    )
    doc.save(word_name)
